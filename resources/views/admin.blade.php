    ...
    <main id="main" class="px-4 py-6 lg:max-w-[52rem] xl:max-w-[71.1rem] lg:ms-64 xl:ms-auto h-screen">
        ...
        <main class="flex-1 pb-8">
            <div class="bg-white w-full h-full rounded shadow-lg">
                <!-- Title -->
                <x-header>Data Tata Usaha</x-header>
                <hr class="mt-3 border border-slate-500">

                <!-- Search bar -->
                <div class="my-10 px-10 flex items-center justify-between">
                    <form action="" method="post">
                        <div class="flex items-center gap-3">
                            <label for="cari_data" class="text-sm font-semibold text-black">cari data TU: </label>
                ...
                <div class="flex items-center justify-end gap-6 my-6 px-8">
                    <!-- Tombol Import Start -->
                            ...
                            <tr>
                                ...
                                <td class="py-2 px-4 border-b">
                                    <button class="bg-green text-white font-semibold py-1 px-5 -ml-3 rounded-full"><a
                                            href="edit/editTU">Edit</a></button>
                                </td>
                            </tr>
                            <!-- Aman -->
                        </tbody>
