...
<body class="h-[2000px]">
    ...
    <main id="main" class="p-4 lg:max-w-[52rem] xl:max-w-[70.1rem] lg:ms-64 xl:ms-auto h-screen">
        <div class="bg-white px-6 py-8 rounded shadow-sm">
            <!-- Title -->
            <x-header>Export Data Siswa</x-header>
            <hr class="mt-3 mb-6">
            ...
            <form>
                ...
                <div class="flex space-x-4 justify-between items-center">
                    ...
                    <button type="button" class="bg-bgLogOut text-white hover:bg-green-900 px-4 py-2 rounded-md"><a
                            href="/siswa">Kembali</a></button>
            </form>
        </div>
    </main>
