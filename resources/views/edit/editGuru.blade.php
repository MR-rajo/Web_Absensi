...
<body class="h-[2000px] bg-gray-100">
    ...
    <main id="main" class="p-4 lg:max-w-[52rem] xl:max-w-[71.1rem] lg:ms-64 xl:ms-auto h-screen">
        <div class="bg-white px-6 py-8 rounded shadow-md">
            <!-- Title -->
            <x-header>Form Edit Data Guru</x-header>
            ...
            <form>
                <div class="mb-4">
                    ...
                    <input type="text" id="nama" class="border-2 w-1/3 p-2 mt-1 rounded-md">
                </div>
                
                <div class="mb-4">
                    <label for="nik" class="block text-gray-600 font-semibold text-lg">NIK :</label>
                    <input type="text" id="nik" class="border-2 w-1/3 p-2 mt-1 rounded-md">
                </div>

                <div class="mb-4">
                    <label for="mapel" class="block text-gray-600 font-semibold text-lg">Mata Pelajaran :</label>
                    <select class=" border-2 rounded-md w-1/3 py-2 px-3 mt-1 text-gray-700 leading-tight focus:outline-none focus:border-blue-500" id="mapel">
                      <option value=""></option>
                ...
                <!-- Submit Button -->
                <button type="submit" class="bg-green font-semibold text-white hover:bg-green-800 px-7 py-2 rounded-lg">Edit</button>
            </form>
        </div>
    </main>
