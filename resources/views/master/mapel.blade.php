    ...
    <main id="main" class="p-8 lg:max-w-[52rem] xl:max-w-[71.1rem] lg:ms-64 xl:ms-auto h-screen">
        ...
        <main class="flex-1">
            <div class="bg-white rounded shadow-lg">
                <!-- Title -->
                <x-header>Master Mata Pelajaran</x-header>
                ...
                <div class="my-10 px-10">
                    <form action="" method="post" class="">
                        <div class="flex items-center gap-3">
                            <label for="cari_data" class="text-sm font-semibold text-black">Nama Mata Pelajaran:
                            </label>
                            <div class="relative w-[25%] rounded-lg border border-slate-300">
                ...
                <!-- Tombol Tambah Data -->
                <div class="mb-2 px-8 flex items-center justify-between">
                    <button
                        class="bg-green hover:shadow-lg text-white font-bold py-1 px-6 rounded-2xl flex items-center space-x-2 focus:outline-none">
                    ...
                    <!-- Tombol Import -->
                    <button class="bg-blue hover:shadow-lg text-white font-bold py-2 px-4 rounded focus:outline-none">
                        <a href="/import/mapel">Export</a>
                    </button>
                </div>
                    ...
                    <table class="min-w-full bg-gray-100 rounded">
                        <thead class="bg-gray-200 border">
                            <tr class="mb-4">
                                ...
                                <th class="py-2 px-4 border-b text-left text-gray-600">Nama Mapel</th>
                                <th class="py-2 px-4 border-b text-left text-gray-600">Guru</th>
