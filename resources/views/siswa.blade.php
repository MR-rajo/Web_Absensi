    ...
    <main id="main" class="px-4 py-6 lg:max-w-[52rem] xl:max-w-[71.1rem] lg:ms-64 xl:ms-auto h-screen">
        ...
        <main class="flex-1">
            <div class="bg-white w-full h-full rounded shadow-lg">
                ...
                <div class="my-10 px-10">
                    <form action="" method="post" class="">
                        <div class="flex items-center gap-3">
                            <label for="cari_data" class="text-sm font-semibold text-black">cari data Siswa: </label>
                ...
                <!-- Buttons -->
                <div class="flex justify-end items-center gap-6 mt-6 px-20 pb-10">
                    <!-- Tombol Import -->
                    <button class="bg-blue hover:shadow-lg text-white font-bold py-2 px-4 rounded focus:outline-none">
                        <a href="/import/importSiswa">Export</a>
                    </button>

                    <!-- Tombol Tambah Data -->
                    <a href="/insert/insertSiswa"
                    ...
                    <table class="min-w-full bg-gray-100 rounded">
                        <thead class="bg-gray-200 border">
                            <tr class="mb-4">
                                ...
                                <th class="py-2 px-4 border-b text-left text-gray-600">Opsi</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                ...
                                <td class="py-2 px-4 border-b">
                                    <button class="bg-green text-white font-semibold py-1 px-5 -ml-3 rounded-full"><a
                                            href="/edit/editSiswa">Edit</a></button>
                                </td>
                            </tr>
                            <!-- Aman -->
                        </tbody>
