...
<body>
    <div class="w-full mx-auto max-w-4xl min-h-screen shadow-lg grid grid-cols-3 gap-2">
        ...
        <div class="bg-white col-span-2 p-10">
            <h1 class="text-3xl mb-8 text-center">Create New Data Guru</h1>
            <form>
                <!-- Input Nama -->
                <div class="mb-10 flex space-x-4">
                    <div class="mb-4">
                        <input c`lass="appearance-none border-b-2 border-gray-300 w-30 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:border-blue-500" id="name" type="text" placeholder="Your Name">
                    </div>
                ...
                <div class="mb-5 mt-7">
                    ...
                    <select class=" border rounded border-gray-300 w-96 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:border-blue-500" id="Mata Pelajaran">
                        <option value=""></option>
